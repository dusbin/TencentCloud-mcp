...
children | TNode | - | 单选内容，同 label。TS 类型：`string \| TNode`。 | N
...
label | TNode | - | 主文案。TS 类型：`string \| TNode`。 | N
...
value | String / Number / Boolean | - | 选中的值。TS 类型：`T` `type RadioValue = string \| number \| boolean`。 | N

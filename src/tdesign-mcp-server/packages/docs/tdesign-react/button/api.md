...
children | TNode | - | 按钮内容，同 content。TS 类型：`string \| TNode`。 | N
content | TNode | - | 按钮内容。TS 类型：`string \| TNode`。 | N

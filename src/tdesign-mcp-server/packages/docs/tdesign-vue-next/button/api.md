...
content | String / Slot / Function | - | 按钮内容。TS 类型：`string \| TNode`。 | N
default | String / Slot / Function | - | 按钮内容。TS 类型：`string \| TNode`。 | N
...
icon | Slot / Function | - | 按钮内部图标，可完全自定义。TS 类型：`TNode`。 | N
...
suffix | Slot / Function | - | 右侧内容，可用于定义右侧图标。TS 类型：`TNode`。 | N

...
separator | String / Slot / Function | - | 分隔符。TS 类型：`string \| TNode`。 | N
size | String / Number / Array | 'medium' | 间距大小。TS 类型：`SpaceSize \| SpaceSize[]` `type SpaceSize = number \| string \| SizeEnum`。。 | N